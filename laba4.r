...
# ЧИСЛО ДОШКОЛЬНЫХ ОРГАНИЗАЦИЙ, ОСУЩЕСТВЛЯЮЩИХ ОБРАЗОВАТЕЛЬНУЮ ДЕЯТЕЛЬНОСТЬ ----
gpclibPermit()
...
stat.Regions <- read.csv2('pupil_2017.csv', stringsAsFactors = F)
...
spplot(Regions1, 'count_2017', main = 'Численность дошкольных организаций',
